...
const SellingPage = () => {
  ...
  return (
    <>
      ...
      <BottomNavLearning />
      <LearningCarousel heading="Selling Resources " />

      <HorizontalCards headname="Preparing to Sell" data={data} />
      <DownloadSection
        imageUrl={house2img}
        title="Ready for a new address?"
        ...
        buttonText="Explore Selling Options"
      />
      <FinanceDesign
        headname="Marketing Your Home"
        leftCardData={{
          imageUrl: houseimg,
          duration: "9 min read",
          title:
      ...
      />
      <ThreeCards heading="Listing Agents" />
