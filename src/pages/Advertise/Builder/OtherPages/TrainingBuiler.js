...
import HeroText from "../NewContruction/components/HeroText";
import RecentFeatureSection from "../NewContruction/components/RecentFeatureSection";
import BuilderMeetSection from "../NewContruction/components/BuilderMeetSection";
import ResourceCards from "../NewContruction/components/ResourceCards";
...
import BlogsResourceList from "../New and Data/components/BlogsResourceList";

const TrainingBuiler = () => {
  const cardsData = [
    {
      imageUrl: img1,
  ...
  return (
    <>
      ...
      <BuilderBelownav activeTab="Training" />
      <HeroText title="Training" />
