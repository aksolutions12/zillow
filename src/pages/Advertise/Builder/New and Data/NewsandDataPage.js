...
import BlogsResourceList from "./components/BlogsResourceList";

const NewsandDataPage = () => {
  const cardsData = [
    {
      imageUrl: img1,
  ...
  return (
    <>
      ...
      <BuilderBelownav activeTab="News and Data" />
      <HeroText title="News and Data" />
...
export default NewsandDataPage;
