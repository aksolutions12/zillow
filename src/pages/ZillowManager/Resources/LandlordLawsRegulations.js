...
import BlogsResourceList from "../../Advertise/Builder/New and Data/components/BlogsResourceList";
...
const LandlordLawsRegulations = () => {
  ...
  return (
    <>
      ...
      <HeroText title="Landlord Laws & Regulations" />
...
export default LandlordLawsRegulations;
