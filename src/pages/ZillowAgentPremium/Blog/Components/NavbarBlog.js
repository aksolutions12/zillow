...
const NavbarBlog = () => {
  ...
  return (
    <nav className="bg-white text-white p-4 flex justify-between pt-8 items-center relative">
      ...
      <div className="hidden lg:flex gap-8">
        ...
        >
          <button className="py-2 px-4 hover:bg-gray-100 rounded-lg text-black hover:text-blue-700 flex items-center">
            Solutions{" "}
            <svg
          ...
          <div
            ...
            } bg-gray-50 text-black mt-1 p-2 w-44 rounded-lg`}
          >
            <Link
        ...
        >
          ...
          >
            <Link
              to="/agentPremium/blog" // Specify the desired route
              className="block px-4 py-2 hover:bg-blue-100 hover:rounded-lg"
            >
              Blog
            </Link>
